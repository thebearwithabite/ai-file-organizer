...
-- Ryan Thomson's Enhanced File Search Tool

-- Configuration
set pythonPath to "/Users/ryanthomson/py312_env/bin/python"
set librarianPath to "/Users/ryanthomson/Github/ai-file-organizer/enhanced_librarian.py"
...
try
	...
	if searchQuery is not "" then
		...
		if buttonPressed is "New Search" then
			-- Restart search
			do shell script "osascript " & quoted form of "/Users/ryanthomson/Github/ai-file-organizer/Enhanced_Search_GUI.applescript" & " &"
