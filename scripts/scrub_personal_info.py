...
def scrub_file(file_path: Path):
    ...
    if not file_path.exists() or file_path.name == 'scrub_personal_info.py' or file_path.suffix not in ['.py', '.md', '.txt', '.json', '.yml', '.yaml']:
        return False
    ...
    try:
        ...
        replacements = {
            ...
            r'user@gmail\.com': 'user@example.com',
            r'rt@papersthatdream\.com': 'user@example.com',
            
            # File paths with personal information
            r'/Users/ryanthomson/': '/Users/user/',
            r'/Users/ryan/': '/Users/user/',
            r'GoogleDrive-thebearwithabite@gmail\.com': 'user@example.com',
            r'thebearwithabite': 'user',
