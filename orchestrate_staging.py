...
def orchestrate(dry_run: bool = False, confidence_threshold: float = 0.90):
    ...
    # 3. Scan and Process Staging Areas
    logger.info("Step 3: Scanning Staging Areas...")
    ...
    for staging_area in triage_service.staging_areas:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold", type=float, default=0.90, help="Confidence threshold for auto-move")
    
    args = parser.parse_args()
    
    orchestrate(dry_run=args.dry_run, confidence_threshold=args.threshold)
