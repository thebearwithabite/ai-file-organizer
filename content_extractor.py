...
class ContentExtractor:
    ...
    def extract_content(self, file_path: Path, db_connection: Optional[sqlite3.Connection] = None) -> Dict[str, Any]:
        ...
        if self._is_content_cached(file_path, current_hash, db_connection=db_connection):
            return self._get_cached_content(file_path, db_connection=db_connection)
        ...
        # Cache the result
        self._cache_content(file_path, current_hash, result, db_connection=db_connection)
