...
class ContentExtractor:
    ...
    def _get_connection(self, db_connection=None):
        """Context manager for database connections (supports reuse)"""
        if db_connection:
            yield db_connection
        else:
    ...
    def search_content(self, query: str, limit: int = 10, db_connection: Optional[sqlite3.Connection] = None) -> List[Dict[str, Any]]:
    ...
    def get_extraction_stats(self, db_connection: Optional[sqlite3.Connection] = None) -> Dict[str, Any]:
