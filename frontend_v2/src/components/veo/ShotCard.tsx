                    ...
                    <div className="flex-grow h-[300px] overflow-auto bg-black/60 rounded-3xl p-6 border border-white/5 font-mono text-[10px] relative group shadow-inner scrollbar-hide">
                        ...
                        <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus-within:translate-y-0 transition-all translate-y-2 group-hover:translate-y-0">
                            <button
                                ...
                                className="px-3 py-1.5 bg-white/10 backdrop-blur-md rounded-lg hover:bg-white/20 text-white text-[9px] font-black uppercase tracking-widest transition-all focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:outline-none" aria-label="Copy JSON content"
                            >
                                {copyButtonText}
                            </button>
                        </div>
