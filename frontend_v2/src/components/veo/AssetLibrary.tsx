        ...
        <div className="group relative bg-white/5 rounded-2xl border border-white/10 overflow-hidden flex flex-col transition-all hover:border-white/20 hover:bg-white/10 shadow-xl">
            ...
            <div className="aspect-[4/3] bg-black/40 relative overflow-hidden">
                {asset.image ? (
                    ...
                    <label className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-white/5 transition-all group/upload focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-inset focus-within:outline-none">
