            ...
            <div className="p-4 flex-grow flex flex-col gap-2">
                ...
                <div className="flex items-start justify-between gap-3 flex-1">
                    ...
                    <button
                        ...
                        className="text-white/20 hover:text-white transition-colors flex-shrink-0 mt-0.5 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none rounded"
