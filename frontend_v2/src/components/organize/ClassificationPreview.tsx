...
export default function ClassificationPreview({ result, onClose }: ClassificationPreviewProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleSkip}
        className="w-full mt-3 text-sm text-white/60 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 rounded"
      >
        Skip (organize later)
      </button>
    </motion.div>
