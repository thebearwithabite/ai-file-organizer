...
export default function ClassificationPreview({ result, onClose }: ClassificationPreviewProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleSkip}
        className="w-full mt-3 text-sm text-white/60 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-background/50 focus-visible:outline-none rounded-lg"
      >
        Skip (organize later)
      </button>
    </motion.div>
