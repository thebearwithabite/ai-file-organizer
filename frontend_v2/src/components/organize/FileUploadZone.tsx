...
interface FileUploadZoneProps {
  onClassificationComplete: (result: unknown) => void
}
...
export default function FileUploadZone({ onClassificationComplete }: FileUploadZoneProps) {
  ...
  return (
    <div
      {...getRootProps()}
      className={cn(
        "border-2 border-dashed rounded-2xl p-12 text-center transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none",
        isDragActive
