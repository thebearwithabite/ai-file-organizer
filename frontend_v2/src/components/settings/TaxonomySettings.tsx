                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                disabled={cat.locked}
                                                className="p-2 hover:bg-white/10 rounded-lg text-white/60 hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-none"
                                                title="Edit Metadata"
                                            ...
                                            <button
                                                ...
                                                aria-label={`Rename folder for ${cat.display_name}`}
                                            >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center p-6 border-b border-white/10">
                            ...
                            <button onClick={() => setEditCategory(null)} className="text-white/40 hover:text-white p-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-none" aria-label="Close edit dialog">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center p-6 border-b border-white/10">
                            ...
                            <button onClick={() => setRenameCategory(null)} className="text-white/40 hover:text-white p-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-none" aria-label="Close rename dialog">
                                <X size={20} aria-hidden="true" />
                            </button>
                        </div>
                        <div className="p-6 space-y-4">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center p-6 border-b border-white/10 sticky top-0 bg-[#1a1a1a] z-10">
                            ...
                            <button onClick={() => setCreateDialogOpen(false)} className="text-white/40 hover:text-white p-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:outline-none" aria-label="Close add new category dialog">
                                <X size={20} aria-hidden="true" />
                            </button>
                        </div>
                        <div className="p-6 space-y-4">
