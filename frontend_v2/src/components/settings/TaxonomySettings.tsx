                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                aria-label="Rename Category & Folder"
                                            >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center p-6 border-b border-white/10">
                            ...
                            <button onClick={() => setEditCategory(null)} className="text-white/40 hover:text-white focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-lg p-1" aria-label="Close edit metadata dialog">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center p-6 border-b border-white/10">
                            ...
                            <button onClick={() => setRenameCategory(null)} className="text-white/40 hover:text-white focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-lg p-1" aria-label="Close rename category dialog">
                                <X size={20} aria-hidden="true" />
                            </button>
                        </div>
                        <div className="p-6 space-y-4">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center p-6 border-b border-white/10 sticky top-0 bg-[#1a1a1a] z-10">
                            ...
                            <button onClick={() => setCreateDialogOpen(false)} className="text-white/40 hover:text-white focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-lg p-1" aria-label="Close add category dialog">
                                <X size={20} aria-hidden="true" />
                            </button>
                        </div>
                        <div className="p-6 space-y-4">
