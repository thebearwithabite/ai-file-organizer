        ...
        return (
            <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                ...
                <button
                    ...
                    className="px-6 py-3 bg-primary text-white rounded-xl hover:bg-primary/80 transition-all font-medium focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary/50"
                >
        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <header className="px-8 py-6 border-b border-white/10 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={loadFiles}
                        className="p-2.5 bg-white/5 border border-white/10 rounded-xl text-white/60 hover:text-white hover:bg-white/10 transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary/50"
                        ...
                        {loading ? (
                            ...
                            filteredFiles.map((file) => (
                                <button
                                    ...
                                    className={cn(
                                        "w-full text-left p-3 rounded-xl transition-all border group focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary/50",
