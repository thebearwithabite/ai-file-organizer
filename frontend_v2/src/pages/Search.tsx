    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="relative" role="search">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 px-6 py-2 bg-primary hover:bg-primary/90 rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        >
          Search
        </button>
      </form>
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm text-white/80 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
              >
                {example}
              </button>
            ))}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 rounded-xl text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-xl text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                        >
                          <FolderOpen size={16} />
                          Copy Path
                        </button>
